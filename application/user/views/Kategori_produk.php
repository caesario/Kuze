        ...
        <div class="container-flu c-padding-header">
            <div class="c-breadcrumb">
                <nav class="c-nav-breadcrumb">
                    ...
                    <span class="breadcrumb-item c-breadcrum-active">Kategori Produk</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid c-padding-header">
        ...
        <div class="row">
            ...
            <div class="col-12 col-sm-12 col-md-2 col-lg-2">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-1 ml-1 ">
                        <a class="r-kat-item" href="#">Baju</a>
                    </li>

                    <li class="nav-item mb-1 ml-1 ">
                        <a class="r-kat-item" href="#">Kemeja</a>
                    </li>
            ...
            <div class="col-12 col-sm-12 col-md-10 col-lg-10">
                <h5 class="card-title mb-1 ml-5">Produk Item</h5>
