...
<div class="container">
    <div class="row align-items-center">
        ...
        <div class="col text-center">
            <img class="img-fluid mt-5" src="<?= base_url('assets/img/error-404.png'); ?>" alt="404">
            <a class="btn btn-csr c-btn-cart font-weight-normal" href="<?= site_url('/'); ?>">Kembali ke halaman utama</a>
        </div>
        <div class="col-2"></div>
    </div>
    <div class="row align-items-center">
