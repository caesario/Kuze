...
?>
    ...
    <div class="container-fluid c-padding-header c-margin-bot-detail-order ">
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="card bg-light" id="detilpesanan">
                    <div class="container">
                        <h5 class="text-center c-order-info mt-4">ORDER ID : #<?= $orders_noid; ?></h5>
                        <p class="text-center c-order-info mt-2 mb-4 no-print">Status :
                                    ...
                                    <?php foreach ($orders->order_detil as $detil): ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><span
                                                        class="c-price-cart-3"><?= $detil->orders_detil_qty; ?></span>
                                            </td>
                    ...
                    <div class="container">
                        <div class="c-cart-total col-lg-6 col-md-6 col-sm-7 px-0 px-sm-3 float-right">
                            ...
                            <?php if ($orders->orders_status < 6): ?>
                                <a href="<?= base_url() . 'order_status'; ?>"
                                   class="btn btn-csr c-btn-cart mt-3 float-right no-print">Back</a>
                            <?php elseif ($orders->orders_status == 6): ?>
                                <a href="<?= base_url() . 'order_history'; ?>"
                                   class="btn btn-csr c-btn-cart mt-3 float-right">Back</a>
                            <?php endif; ?>
                            <a class="btn btn-csr c-btn-cart mt-3 float-right mr-2 no-print" id="btnprint">Print</a>
                        </div>
                    </div>
                </div>
            </div>
