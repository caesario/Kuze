    ...
    <section>
                        ...
                        <div class="col">
                            <div class="table-responsive">
                                <table id="tables" class="table table-sm">
                                    ...
                                    <tbody>
                                    <?php if ($slide_instas != NULL): ?>
                                        <?php foreach ($slide_instas as $insta): ?>
                                            <tr>
                                                <td class="align-middle">
                                                    <div class="fotorama"
                                                         ...
                                                         data-width="220"
                                                         data-height="150">
                                                        <img src="<?= base_url('upload/' . $insta->slide_insta_img); ?>"
                                                             width="220" height="150">
                                                    </div>
                                                </td>
                                                <td class="align-middle text-center"><?= $insta->slide_insta_isaktif == 0 ? '<i class="fas fa-times"></i>' : '<i class="fas fa-check"></i>'; ?></td>
                                                <td class="align-middle"><?= $insta->created_at; ?></td>
                                                <td class="align-middle"><?= $insta->updated_at; ?></td>
                                                <td class="align-middle">
                                                    <a data-toggle="modal" class="btn btn-sm btn-primary"
                                                       ...
                                                       data-keyboard="false"
                                                       data-id="<?= $insta->slide_insta_kode; ?>"><i
        ...
        <script>
            ...
            function tambah() {
                ...
                bodymodal.load("<?= site_url('instagram/tambah'); ?>");
            }
            ...
            function edit(data) {
                ...
                bodymodal.load("<?= site_url('instagram/ubah/'); ?>" + id);
            }
            ...
            function detil(data) {
                ...
                bodymodal.load("<?= site_url('instagram/detil/'); ?>" + id);
            }

            function hapus(data) {
                d = data;
                id = d.attr('data-id');
                $('a#hapus').attr('href', "<?= site_url('instagram/hapus/'); ?>" + id);
            }
