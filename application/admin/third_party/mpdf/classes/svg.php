                            ...
                            if ($svg_class->mpdf_ref->useLang && !$svg_class->mpdf_ref->usingCoreFont) {
                                if ($attribs['lang'] != $svg_class->mpdf_ref->default_lang) {
                                    ...
                                    if ($mpdf_pdf_unifonts) {
                                        $styl .= 'font-family:' . $mpdf_pdf_unifonts[0] . ';';
                                    }
                                }
                            }
                        }
    ...
    function AutoFont($html)
    {
        ...
        foreach ($a as $i => $e) {
            if ($i % 2 == 0) {
                ...
                // CJK
                if (preg_match("/[" . $this->mpdf_ref->pregUHCchars . "]/u", $e)) {
                    $lang = 'ko';
                } else if (preg_match("/[" . $this->mpdf_ref->pregSJISchars . "]/u", $e)) {
                    $lang = 'ja';
                } else if (preg_match("/[" . $this->mpdf_ref->pregCJKchars . "]/u", $e)) {
                    $lang = 'zh-CN';
                } // HEBREW
                else if (preg_match("/[" . $this->mpdf_ref->pregHEBchars . "]/u", $e)) {
                    $lang = 'he';
                } // All Arabic
                else if (preg_match("/[" . $sindhi . "]/u", $e)) {
                    $lang = 'si';
                } else if (preg_match("/[" . $urdu . "]/u", $e)) {
                    $lang = 'ur';
                } else if (preg_match("/[" . $pashto . "]/u", $e)) {
                    $lang = 'ps';
                } else if (preg_match("/[" . $persian . "]/u", $e)) {
                    $lang = 'fa';
                } else if (preg_match("/[" . $this->mpdf_ref->pregARABICchars . "]/u", $e)) {
                    $lang = 'ar';
                } else if (preg_match("/[" . $this->mpdf_ref->pregBNchars . "]/u", $e)) {
                    $lang = 'bn';
                } else if (preg_match("/[" . $this->mpdf_ref->pregHIchars . "]/u", $e)) {
                    $lang = 'hi';
                } else if (preg_match("/[" . $this->mpdf_ref->pregGUchars . "]/u", $e)) {
                    $lang = 'gu';
                } else if (preg_match("/[" . $this->mpdf_ref->pregMLchars . "]/u", $e)) {
                    $lang = 'ml';
                } else if (preg_match("/[" . $this->mpdf_ref->pregKNchars . "]/u", $e)) {
                    $lang = 'kn';
                } else if (preg_match("/[" . $this->mpdf_ref->pregORchars . "]/u", $e)) {
                    $lang = 'or';
                } else if (preg_match("/[" . $this->mpdf_ref->pregPAchars . "]/u", $e)) {
                    $lang = 'pa';
                } else if (preg_match("/[" . $this->mpdf_ref->pregTAchars . "]/u", $e)) {
                    $lang = 'ta';
                } else if (preg_match("/[" . $this->mpdf_ref->pregTEchars . "]/u", $e)) {
                    $lang = 'te';
                } // THAI
                else if (preg_match("/[\x{0E00}-\x{0E7F}]/u", $e)) {
                    $lang = 'th';
                } // Vietnamese
                else if (preg_match("/[" . $this->mpdf_ref->pregVIETchars . "]/u", $e)) {
                    $lang = 'vi';
                }
